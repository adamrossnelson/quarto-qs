...
In the very important paper by @rogers2020semantics, the authors found that it is coll to use Quarto.

You can also just give an assertion with a parenthetical citation this way [@rogers2020semantics].

Did you know that @fig-slides-boxplot is a box plot?
